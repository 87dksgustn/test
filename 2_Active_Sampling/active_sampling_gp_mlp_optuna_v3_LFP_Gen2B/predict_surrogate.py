...
def build_parser():
    ...
    parser.add_argument("--A_Cell_D", type=float)
    parser.add_argument("--C_Barrier_Thx", type=float)
    parser.add_argument("--E_Barrier_Outer_Thx", type=float)
    parser.add_argument("--F_ThermalResin_Thx", type=float)
    parser.add_argument("--B_Barrier_Type", type=str)
    parser.add_argument("--D_Barrier_Outer_Type", type=str)
    return parser
